...
export const SERVICE_REGISTRY: readonly ServiceSpec[] = [
  ...
  {
    id: "fixExchange",
    displayName: "FIX Exchange",
    envPrefix: "FIX_EXCHANGE",
    composeName: "fix-exchange",
    defaultPort: 9880,
    category: "infra",
  ...
  },
  {
    ...
    displayName: "Synthetic Trader (Equity HT)",
    envPrefix: "SYNTHETIC_TRADER_EQUITY_HIGH_TOUCH",
    composeName: "synthetic-trader-equity-high-touch",
    defaultPort: 5043,
    category: "algo",
  ...
  },
  {
    ...
    displayName: "Synthetic Trader (Equity LT)",
    envPrefix: "SYNTHETIC_TRADER_EQUITY_LOW_TOUCH",
    composeName: "synthetic-trader-equity-low-touch",
    defaultPort: 5036,
    category: "algo",
  ...
  },
  {
    ...
    displayName: "Synthetic Trader (FX Electronic)",
    envPrefix: "SYNTHETIC_TRADER_FX_ELECTRONIC",
    composeName: "synthetic-trader-fx-electronic",
    defaultPort: 5037,
    category: "algo",
  ...
  },
  {
    ...
    displayName: "Synthetic Trader (FX HT)",
    envPrefix: "SYNTHETIC_TRADER_FX_HIGH_TOUCH",
    composeName: "synthetic-trader-fx-high-touch",
    defaultPort: 5038,
    category: "algo",
  ...
  },
  {
    ...
    displayName: "Synthetic Trader (FI Voice)",
    envPrefix: "SYNTHETIC_TRADER_FI_VOICE",
    composeName: "synthetic-trader-fi-voice",
    defaultPort: 5039,
    category: "algo",
  ...
  },
  {
    ...
    displayName: "Synthetic Trader (Derivatives HT)",
    envPrefix: "SYNTHETIC_TRADER_DERIVATIVES_HIGH_TOUCH",
    composeName: "synthetic-trader-derivatives-high-touch",
    defaultPort: 5040,
    category: "algo",
  ...
  },
  {
    ...
    displayName: "Synthetic Trader (Derivatives LT)",
    envPrefix: "SYNTHETIC_TRADER_DERIVATIVES_LOW_TOUCH",
    composeName: "synthetic-trader-derivatives-low-touch",
    defaultPort: 5041,
    category: "algo",
  ...
  },
  {
    ...
    displayName: "Synthetic Trader (Commodities Voice)",
    envPrefix: "SYNTHETIC_TRADER_COMMODITIES_VOICE",
    composeName: "synthetic-trader-commodities-voice",
    defaultPort: 5042,
    category: "algo",
  ...
  },
  {
    ...
    envPrefix: "POSTGRES_HEALTH",
    composeName: "postgres-health",
    defaultPort: 8100,
    category: "data",
  ...
  },
  {
    ...
    envPrefix: "REDPANDA_ADMIN",
    composeName: "redpanda",
    defaultPort: 9644,
    category: "infra",
