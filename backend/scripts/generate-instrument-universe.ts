...
import { CURATED_EQUITY_SEEDS } from "../src/market-sim/sp500-assets.ts";
import { CURATED_FX_SEEDS } from "../src/market-sim/fx-assets.ts";
import { CURATED_COMMODITY_SEEDS } from "../src/market-sim/commodity-assets.ts";
...
// hand-curated on-the-run points in bond-universe.ts).
...
async function writeEquities(): Promise<void> {
  ...
  const path = new URL("../src/market-sim/generated-equities.ts", import.meta.url);
  const lines: string[] = [
    ...
    "",
    'import type { RawAssetSeed } from "./sp500-assets.ts";',
    "",
...
async function writeFx(): Promise<void> {
  ...
  const path = new URL("../src/market-sim/generated-fx.ts", import.meta.url);
  const lines: string[] = [
    "// Generated by backend/scripts/generate-instrument-universe.ts — do not hand-edit.",
    "// Synthetic FX crosses (minors/EM) appended to FX_ASSETS.",
    "",
    'import type { RawFxSeed } from "./fx-assets.ts";',
    "",
...
async function writeCommodities(): Promise<void> {
  ...
  const path = new URL("../src/market-sim/generated-commodities.ts", import.meta.url);
  const lines: string[] = [
    "// Generated by backend/scripts/generate-instrument-universe.ts — do not hand-edit.",
    "// Synthetic commodity futures appended to COMMODITY_ASSETS.",
    "",
    'import type { RawCommoditySeed } from "./commodity-assets.ts";',
    "",
...
async function writeBonds(): Promise<void> {
  ...
  const lines: string[] = [
    ...
    "// backend/src/market-sim/bond-universe.ts and frontend/src/data/bondUniverse.ts",
