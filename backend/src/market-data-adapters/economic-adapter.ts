...
const MACRO_CALENDAR: MacroTemplate[] = [
  {
    headline: "Federal Reserve FOMC Meeting Minutes",
    impact: "high",
    weekOffset: 1,
  },
  ...
  {
    headline: "US Producer Price Index (PPI)",
    impact: "medium",
    weekOffset: 1,
  },
  ...
  {
    headline: "ECB Monetary Policy Statement",
    impact: "medium",
    weekOffset: 3,
  },
  {
    headline: "Bank of England Rate Decision",
    impact: "medium",
    weekOffset: 4,
  },
