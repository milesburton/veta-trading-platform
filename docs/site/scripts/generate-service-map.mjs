...
const lines = [
  ...
  "",
  "Ports listed below are the internal listening ports used inside the dev container and the docker compose network. In production deployments the services are not exposed on these ports directly: public traffic enters via the [Traefik](./supporting/traefik/) ingress and is routed to services over the internal Docker network.",
  "",
