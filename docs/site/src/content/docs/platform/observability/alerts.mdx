...
Header emoji follows the worst service-availability window in the day: ✅ 100%, ⚠️ 95–99.9%, 🚨 below 95%. So a daily summary with ✅ means no service flapped past 99.9% in any 5-second sample during the day.
