...
description: The Spark workstation at <gpu-host> hosts Ollama with a handful of local models. LLM-advisory and any other inference-heavy workload should target it rather than going to external APIs.
---
...
- **Host**: `<gpu-host>` (separate machine from the homelab proper at `<homelab-host>`)
