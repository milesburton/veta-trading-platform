...
- **Virtualised rendering**: handles hundreds of instruments smoothly
...
Administrators control this banner, and it is dismissed automatically when the upgrade completes.
