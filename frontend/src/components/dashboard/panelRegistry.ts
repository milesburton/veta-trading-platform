...
export const PANEL_DESCRIPTIONS: Record<PanelId, string> = {
  ...
  "platform-status":
    "Last 24h roll-up: service availability, alert counts, user tickets, and last critical event. Raise-ticket button notifies Support and creates GitHub issues when configured. Drives the daily Support summary at 09:00 UTC.",
};
...
export const PANEL_CHANNEL_CAPS: Record<PanelId, { out: boolean; in: boolean }> = {
  "fix-sessions": { out: false, in: false },
...
export const PANEL_PERMISSIONS: Record<PanelId, ReadonlySet<AuthRole>> = {
  "fix-sessions": new Set<AuthRole>(["risk-manager", "compliance", "oncall", "admin"]),
  ...
  "algo-monitor": new Set<AuthRole>(["trader", "desk-head", "risk-manager", "admin", "compliance"]),
  ...
  "decision-log": new Set<AuthRole>(["trader", "desk-head", "risk-manager", "admin", "compliance"]),
  ...
  "order-progress": new Set<AuthRole>([
    "trader",
    "desk-head",
    "risk-manager",
    "admin",
  ...
  "option-pricing": new Set<AuthRole>([
    "trader",
    "desk-head",
    "risk-manager",
    "admin",
  ...
  "scenario-matrix": new Set<AuthRole>([
    "trader",
    "desk-head",
    "risk-manager",
    "admin",
  ...
  "trade-recommendation": new Set<AuthRole>([
    "trader",
    "desk-head",
    "risk-manager",
    "admin",
  ...
  "research-radar": new Set<AuthRole>([
    "trader",
    "desk-head",
    "risk-manager",
    "admin",
  ...
  "instrument-analysis": new Set<AuthRole>([
    "trader",
    "desk-head",
    "risk-manager",
    "admin",
  ...
  "throughput-gauges": new Set<AuthRole>(["desk-head", "risk-manager", "admin", "compliance"]),
  "algo-leaderboard": new Set<AuthRole>([
    "trader",
    "desk-head",
    "risk-manager",
    "admin",
  ...
  "estate-overview": new Set<AuthRole>(["desk-head", "risk-manager", "admin", "compliance"]),
  "yield-curve": new Set<AuthRole>([
    "trader",
    "desk-head",
    "risk-manager",
    "admin",
  ...
  "spread-analysis": new Set<AuthRole>([
    "trader",
    "desk-head",
    "risk-manager",
    "admin",
  ...
  "duration-ladder": new Set<AuthRole>([
    "trader",
    "desk-head",
    "risk-manager",
    "admin",
  ...
  "symbol-search": new Set<AuthRole>([
    "trader",
    "desk-head",
    "risk-manager",
    "admin",
