import { isStrategyAllowedInSession } from "@veta/frontend/domain/market/marketSession";
import { quantityLabel, quantitySubLabel, STRATEGY_OPTIONS } from "./fieldDefinitions";
import { FIELD_REGISTRY, FK } from "./fieldRegistry";
import { checkDarkPoolEligible } from "./rules/darkPool";
import { availableInstrumentTypes, runDeskAccessCheck } from "./rules/deskAccess";
import { runInstrumentSpecCheck } from "./rules/instrumentSpec";
import { runKillSwitchCheck } from "./rules/killSwitch";
import { runLimitChecks } from "./rules/limitChecks";
import { runPriceCollarCheck } from "./rules/priceCollar";
import { checkRoleLocked } from "./rules/roleCheck";
import { runSessionRules } from "./rules/sessionRules";
import { runSpreadCheck } from "./rules/spreadCheck";
import { runStaticValidation } from "./rules/staticValidation";
import { runVenueRules } from "./rules/venueRules";
import type {
  Diagnostic,
  FieldOrigin,
  ResolvedField,
