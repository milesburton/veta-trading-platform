import { isAuction, isStrategyAllowedInSession } from "@veta/frontend/domain/market/marketSession";
import type { Diagnostic, TicketContext } from "@veta/frontend/domain/ticket/ticketTypes";
