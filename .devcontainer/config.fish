...
if status is-interactive
  ...
  echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" | lolcat
  echo "  All 29 services start automatically via supervisord."
  ...
  echo "    run-observability      Event store                 :5007"
  echo "    run-kafka-relay        Kafka → Loki relay          :5007"
...
alias run-observability="cd $WS && deno run --allow-all backend/src/observability/observability-server.ts"
alias run-kafka-relay="cd $WS && deno run --allow-all backend/src/kafka-relay/kafka-relay.ts"
alias run-analytics="cd $WS && deno run --allow-all backend/src/analytics/analytics-server.ts"
alias run-market-data="cd $WS && deno run --allow-all backend/src/market-data-service/market-data-service.ts"
alias run-news="cd $WS && deno run --allow-all backend/src/news-aggregator/news-aggregator.ts"
...
alias run-llm-advisory="cd $WS && deno run --allow-all backend/src/llm-advisory-orchestrator/orchestrator.ts"
